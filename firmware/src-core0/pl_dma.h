...
// Separate non-cacheable staging buffer for the wavelet stream (see pl_dma.c).
extern uint8_t pl_dma_wav_staging[];
#define WAV_DMA_BUF_ADDR  ((uintptr_t)pl_dma_wav_staging)

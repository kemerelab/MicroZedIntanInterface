...
// see wavelet_dsp_block.sv). Build params: K=32, N_OCTAVES=8, V=6, N_TAPS=40
// (FINE variant: finer scale grid + longer/sharper voices).
...
#define WAV_N_SCALES                (WAV_N_OCTAVES * WAV_V)   // 48 scales (build max)

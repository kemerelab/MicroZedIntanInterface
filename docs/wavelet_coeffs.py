...
#
#   Branch:  claude/tier3-wavelet-lowlat   (the low-latency / real-time build)
#   Config:  V=4 voices/octave, N_TAPS=16, N_OCTAVES=5, HB_TAPS=7,
...
# ---- branch config (mirror of main.h / net.py for claude/tier3-wavelet-lowlat) ----
...
def _print_bank():
    b = coefficients()
    c = b['config']
    print("# wavelet bank -- branch claude/tier3-wavelet-lowlat  (true Morse, ghostipy)")

...
#
#   Branch:  claude/tier3-wavelet-fine   (the finer-grid / sharper build)
#   Config:  V=6 voices/octave, N_TAPS=40, N_OCTAVES=8, HB_TAPS=7,
...
#   analytic formula matches ghostipy to 0.0; the 40-tap FIR matches its
#   passband shape to <1e-4). See docs/wavelet-coefficients.md.
...
# ---- branch config (mirror of main.h / net.py for claude/tier3-wavelet-fine) ----
V         = 6         # voices per octave
...
def _print_bank():
    b = coefficients()
    c = b['config']
    print("# wavelet bank -- branch claude/tier3-wavelet-fine  (true Morse, ghostipy)")

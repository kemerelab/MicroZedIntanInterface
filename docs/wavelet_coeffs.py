...
#
#   Branch:  claude/tier3-wavelet-v2   (K=176, 4-MAC work-spread engine)
#   Config:  V=4 voices/octave, N_TAPS=24, N_OCTAVES=8, HB_TAPS=7,
#            fs=3000 Hz, fc_top=0.34, gamma=3, beta=3, Q1.17 coeffs
#            (config constants V/N_TAPS/N_OCTAVES are identical to the base
#            claude/tier3-wavelet branch -- only the engine width differs)
#
...
# ---- branch config (mirror of main.h / net.py for claude/tier3-wavelet-v2) ----
...
def _print_bank():
    b = coefficients()
    c = b['config']
    print("# wavelet bank -- branch claude/tier3-wavelet-v2  (true Morse, ghostipy)")

...
#
#   Branch:  claude/tier3-wavelet   (the "standard" full-range build)
...
# ---- branch config (mirror of main.h / net.py for claude/tier3-wavelet) ----
...
def _print_bank():
    b = coefficients()
    c = b['config']
    print("# wavelet bank -- branch claude/tier3-wavelet  (true Morse, ghostipy)")

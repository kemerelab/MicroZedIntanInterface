...
# module references:
# simple_dual_port_bram_wrapper, led_status_controller, axi_lite_registers, data_generator, cipo_lvds, output_lvds
...
proc create_root_design { parentCell } {
  ...
  set cipo1_p_0 [ create_bd_port -dir I cipo1_p_0 ]
  set cipo0_n_0 [ create_bd_port -dir I cipo0_n_0 ]
  set cipo0_p_0 [ create_bd_port -dir I cipo0_p_0 ]
  set cipo1_n_0 [ create_bd_port -dir I cipo1_n_0 ]
  set csn_n_0 [ create_bd_port -dir O csn_n_0 ]
  set sclk_p_0 [ create_bd_port -dir O sclk_p_0 ]
  set sclk_n_0 [ create_bd_port -dir O sclk_n_0 ]
  set copi_p_0 [ create_bd_port -dir O copi_p_0 ]
  set csn_p_0 [ create_bd_port -dir O csn_p_0 ]
  set copi_n_0 [ create_bd_port -dir O copi_n_0 ]
...
\
  ...
  # Create instance: cipo_lvds_0, and set properties
  set block_name cipo_lvds
  set block_cell_name cipo_lvds_0
  if { [catch {set cipo_lvds_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $cipo_lvds_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: output_lvds_0, and set properties
  set block_name output_lvds
  set block_cell_name output_lvds_0
  if { [catch {set output_lvds_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $output_lvds_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net cipo0_n_0_1  [get_bd_ports cipo0_n_0] \
  [get_bd_pins cipo_lvds_0/cipo0_n]
  connect_bd_net -net cipo0_p_0_1  [get_bd_ports cipo0_p_0] \
  [get_bd_pins cipo_lvds_0/cipo0_p]
  connect_bd_net -net cipo1_n_0_1  [get_bd_ports cipo1_n_0] \
  [get_bd_pins cipo_lvds_0/cipo1_n]
  connect_bd_net -net cipo1_p_0_1  [get_bd_ports cipo1_p_0] \
  [get_bd_pins cipo_lvds_0/cipo1_p]
  connect_bd_net -net cipo_lvds_0_cipo0  [get_bd_pins cipo_lvds_0/cipo0] \
  [get_bd_pins data_generator/cipo0]
  connect_bd_net -net cipo_lvds_0_cipo1  [get_bd_pins cipo_lvds_0/cipo1] \
  ...
  connect_bd_net -net data_generator_copi  [get_bd_pins data_generator/copi] \
  [get_bd_pins output_lvds_0/copi]
  connect_bd_net -net data_generator_csn  [get_bd_pins data_generator/csn] \
  [get_bd_pins output_lvds_0/csn]
  connect_bd_net -net data_generator_sclk  [get_bd_pins data_generator/sclk] \
  [get_bd_pins output_lvds_0/sclk]
  ...
  [get_bd_ports led1]
  connect_bd_net -net output_lvds_0_copi_n  [get_bd_pins output_lvds_0/copi_n] \
  [get_bd_ports copi_n_0]
  connect_bd_net -net output_lvds_0_copi_p  [get_bd_pins output_lvds_0/copi_p] \
  [get_bd_ports copi_p_0]
  connect_bd_net -net output_lvds_0_csn_n  [get_bd_pins output_lvds_0/csn_n] \
  [get_bd_ports csn_n_0]
  connect_bd_net -net output_lvds_0_csn_p  [get_bd_pins output_lvds_0/csn_p] \
  [get_bd_ports csn_p_0]
  connect_bd_net -net output_lvds_0_sclk_n  [get_bd_pins output_lvds_0/sclk_n] \
  [get_bd_ports sclk_n_0]
  connect_bd_net -net output_lvds_0_sclk_p  [get_bd_pins output_lvds_0/sclk_p] \
  [get_bd_ports sclk_p_0]

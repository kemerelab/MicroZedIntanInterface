...
module wav_overrun_tb;
    ...
    parameter int K         = 6;     // FINE build: K=6 (real-time-clean sharp grid)
    parameter int N_OCTAVES = 8;
    parameter int V         = 6;     // FINE build: 6 voices/octave
    parameter int N_TAPS    = 40;    // FINE build: 40 taps/voice (sharper voices)
    ...
    parameter int RES_AW    = 16;        // matches build BRAM_ADDR_WIDTH (64 KB result BRAM)

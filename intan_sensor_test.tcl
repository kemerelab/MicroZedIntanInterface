...
#
# intan_sensor_test.tcl: Tcl script for re-creating project 'intan_sensor_test'
#
# Generated by Vivado on Mon Jul 21 21:57:47 CDT 2025
...
#
# 1. This project restoration tcl script (intan_sensor_test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/reet/intan_sensor_test/intan_sensor_test.srcs/sources_1/new/top_module.v"
#    "/home/reet/intan_sensor_test/intan_sensor_test.srcs/sources_1/new/instructions.mem"
#    "/home/reet/intan_sensor_test/intan_sensor_test.srcs/constrs_1/new/constraints.xdc"
#    "/home/reet/intan_sensor_test/intan_sensor_test.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../intan_sensor_test/intan_sensor_test.srcs/sources_1/new/top_module.v"]"\
 "[file normalize "$origin_dir/../../../intan_sensor_test/intan_sensor_test.srcs/sources_1/new/instructions.mem"]"\
 "[file normalize "$origin_dir/../../../intan_sensor_test/intan_sensor_test.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/../../../intan_sensor_test/intan_sensor_test.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "intan_sensor_test"
...
set script_file "intan_sensor_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../intan_sensor_test"]"
...
set file "[file normalize "$origin_dir/../../../intan_sensor_test/intan_sensor_test.srcs/constrs_1/new/constraints.xdc"]"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files [list "*new/constraints.xdc"]]" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/constraints.xdc"]]" -objects $obj
...
if { [get_files [list top_module.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/reet/intan_sensor_test/intan_sensor_test.srcs/sources_1/new/top_module.v
}
...
# top_module
  ...
  set CS_p_0 [ create_bd_port -dir O CS_p_0 ]
  set MISO1_n_0 [ create_bd_port -dir I MISO1_n_0 ]
  set MISO1_p_0 [ create_bd_port -dir I MISO1_p_0 ]
  set MISO2_n_0 [ create_bd_port -dir I MISO2_n_0 ]
  set MISO2_p_0 [ create_bd_port -dir I MISO2_p_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {84} \
...
\
  ...
  # Create instance: rst_ps7_0_83M, and set properties
  set rst_ps7_0_83M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_83M ]
  ...
  connect_bd_net -net MISO1_n_0_1  [get_bd_ports MISO1_n_0] \
  [get_bd_pins top_module_0/MISO1_n]
  connect_bd_net -net MISO1_p_0_1  [get_bd_ports MISO1_p_0] \
  [get_bd_pins top_module_0/MISO1_p]
  connect_bd_net -net MISO2_n_0_1  [get_bd_ports MISO2_n_0] \
  [get_bd_pins top_module_0/MISO2_n]
  connect_bd_net -net MISO2_p_0_1  [get_bd_ports MISO2_p_0] \
  [get_bd_pins top_module_0/MISO2_p]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins ila_0/clk] \
  [get_bd_pins rst_ps7_0_83M/slowest_sync_clk] \
  [get_bd_pins top_module_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins rst_ps7_0_83M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_83M_peripheral_aresetn  [get_bd_pins rst_ps7_0_83M/peripheral_aresetn] \
  [get_bd_pins top_module_0/resetn]
  connect_bd_net -net top_module_0_CS  [get_bd_pins top_module_0/CS] \
  [get_bd_pins ila_0/probe1]
  connect_bd_net -net top_module_0_CS_n  [get_bd_pins top_module_0/CS_n] \
  [get_bd_ports CS_n_0]
  connect_bd_net -net top_module_0_CS_p  [get_bd_pins top_module_0/CS_p] \
  [get_bd_ports CS_p_0]
  connect_bd_net -net top_module_0_MISO1  [get_bd_pins top_module_0/MISO1] \
  [get_bd_pins ila_0/probe3]
  connect_bd_net -net top_module_0_MISO2  [get_bd_pins top_module_0/MISO2] \
  [get_bd_pins ila_0/probe4]
  connect_bd_net -net top_module_0_MOSI  [get_bd_pins top_module_0/MOSI] \
  [get_bd_pins ila_0/probe2]
  connect_bd_net -net top_module_0_MOSI_n  [get_bd_pins top_module_0/MOSI_n] \
  [get_bd_ports MOSI_n_0]
  connect_bd_net -net top_module_0_MOSI_p  [get_bd_pins top_module_0/MOSI_p] \
  [get_bd_ports MOSI_p_0]
  connect_bd_net -net top_module_0_SCLK  [get_bd_pins top_module_0/SCLK] \
  [get_bd_pins ila_0/probe0]
  connect_bd_net -net top_module_0_SCLK_n  [get_bd_pins top_module_0/SCLK_n] \
  [get_bd_ports SCLK_n_0]
  connect_bd_net -net top_module_0_SCLK_p  [get_bd_pins top_module_0/SCLK_p] \
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../intan_sensor_test/intan_sensor_test.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
